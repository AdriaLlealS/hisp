...
def make_W_mb_model(
    ...
    vertices = build_vertices(pb=1e-4, L=L, h0=5e-12, r=1.01, n_const=2000)
...
def make_B_mb_model(
    ...
    vertices = build_vertices(pb=L/10, L=L, h0=1e-13, r=1.01, n_const=1000)
...
def make_B_mb_model_oldBC(
    ...
    custom_atol: Union[
        float, Callable
    ] = 1e12,  # default atol unless otherwise specified, used for FP, ICWC, RISP in hisp-for-iter
    custom_rtol: Union[
        float, Callable
    ] = 1e-7,  # default rtol unless otherwise specified, used for FP, ICWC, RISP in hisp-for-iter
    exports=False,
) -> Tuple[CustomProblem, Dict[str, F.TotalVolume]]:
    """Create a FESTIM model for the B MB scenario.
